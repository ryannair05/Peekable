#include "PABRootListController.h"
#include "PABAppSettingsController.h"
...
@implementation PABRootListController
...
-(NSMutableArray*)appSpecifiers {
    ...
    for (NSString *bundleIdentifier in dataSourceUser.allKeys) {
        ...
        PSSpecifier *spe = [PSSpecifier preferenceSpecifierNamed:displayName target:self set:nil get:@selector(getIsWidgetSetForSpecifier:) detail:[PABAppSettingsController class] cell:PSLinkListCell edit:nil];
